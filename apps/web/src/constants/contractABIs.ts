...
export const InvoiceContractABI = [
  {
    "inputs": [
      {
    ...
    "outputs": [
      {
        ...
        "internalType": "struct InvoiceContract.Invoice[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
